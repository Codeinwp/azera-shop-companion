...
$section_is_empty = ! isset( $azera_shop_happy_customers_show ) || $azera_shop_happy_customers_show == 1 || ( empty( $azera_shop_happy_customers_title ) && empty( $azera_shop_happy_customers_subtitle ) && empty( $azera_shop_testimonials_content ) ) ?>
			...
			if ( ! empty( $azera_shop_happy_customers_title ) || ! empty( $azera_shop_happy_customers_subtitle ) ) { ?>
                <div class="section-header">
	                ...
	                if ( ! empty( $azera_shop_happy_customers_title ) ) { ?>
                        <h2 class="dark-text"><?php echo wp_kses_post( $azera_shop_happy_customers_title ); ?></h2><div class="colored-line"></div>
		                <?php
                                ...
                                <div class="feedback border-bottom-hover">
                                    <div class="pic-container">
                                        <div class="pic-container-inner">
                                            <?php
                                            if ( ! empty( $image ) ) { ?>
                                                <img src="<?php echo esc_url( $image ); ?>" alt="<?php echo ( ! empty( $title ) ? esc_attr( $title ) : esc_attr( 'Avatar','azera-shop-companion' ) ); ?>">
                                                <?php
                                            } else {
                                                $default_image = azera_shop_get_file( '/images/clients/client-no-image.jpg' ); ?>
                                                <img src="<?php echo esc_url( $default_image ); ?>" alt="<?php esc_attr_e( 'Avatar','azera-shop-companion' ); ?>">
                                                <?php
                                            } ?>
                                        </div>
                                    </div>
