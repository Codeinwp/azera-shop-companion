...
$section_is_empty               = ! isset( $azera_shop_our_team_show ) || $azera_shop_our_team_show == 1 || ( empty( $azera_shop_our_team_title ) && empty( $azera_shop_our_team_subtitle ) && empty( $azera_shop_team_content ) ); ?>

<section class="team <?php if ( $section_is_empty ) {
	echo 'azea_shop_only_customizer';
} ?>" id="team" role="region" aria-label="'<?php esc_attr_e( 'Team', 'azera-shop-companion' ); ?>" <?php echo ! empty( $azera_shop_our_team_background ) ? 'style="background:url(' . esc_url( $azera_shop_our_team_background ) . ');"' : ''; ?>>
